...
static long long get_time_in_microseconds();
ret_t create_test_data_set(file_t ***file_set, u32 *count);
ret_t async_read_one_picture_to_file(void **buffer, char8 *filename, u32 *length);
ret_t async_write_one_picture_to_file(void *buffer, char8 *filename, u32 length);
ret_t sync_read_one_picture_to_file(void **buffer, char8 *filename, u32 *length);
...
int main(int argc, char *argv[])
{
    ...
    async_file_accessor_t *pFileAccessor = g_en_async ? Async_File_Accessor_Get_Instance(g_async_method_type) : NULL;
    ...
    {
        res = g_en_async
              ? async_read_one_picture_to_file(&(file_set[i]->buf),
                                               file_set[i]->input_filename,
                                               &(file_set[i]->size))
              : sync_read_one_picture_to_file(&(file_set[i]->buf),
                                              file_set[i]->input_filename,
                                              &(file_set[i]->size));
    }

    sleep(5);
    res = g_en_async ? pFileAccessor->waitAll(pFileAccessor) : res;
    ...
    {
        res = g_en_async
              ? async_write_one_picture_to_file(file_set[i]->buf,
    ...
    printf("- Cancel and release all resource.\n");
    res = g_en_async ? pFileAccessor->cancelAll(pFileAccessor) : res;
    res = g_en_async ? pFileAccessor->releaseAll(pFileAccessor) : res;
...
static void parse_args(int argc, char *argv[])
{
    ...
    g_en_async = strcmp(argv[1], "0") ? TRUE : FALSE;
...
ret_t create_test_data_set(file_t ***file_set, u32 *count)
{
    ...
    *file_set   = (file_t **)malloc(sizeof(file_t *)*(*count));
    ...
    (*file_set)[0]->input_filename   = DATA_SET_DIR"/RAW_4K_0.RAW";
    (*file_set)[1]->input_filename   = DATA_SET_DIR"/RAW_4K_1.RAW";
    (*file_set)[2]->input_filename   = DATA_SET_DIR"/RAW_4K_2.RAW";
    (*file_set)[3]->input_filename   = DATA_SET_DIR"/RAW_4K_3.RAW";
    (*file_set)[4]->input_filename   = DATA_SET_DIR"/RAW_4K_4.RAW";
    (*file_set)[5]->input_filename   = DATA_SET_DIR"/RAW_4K_5.RAW";
    (*file_set)[6]->input_filename   = DATA_SET_DIR"/RAW_4K_6.RAW";
    (*file_set)[7]->input_filename   = DATA_SET_DIR"/RAW_4K_7.RAW";
    (*file_set)[8]->input_filename   = DATA_SET_DIR"/RAW_4K_8.RAW";
    (*file_set)[9]->input_filename   = DATA_SET_DIR"/RAW_4K_9.RAW";

    (*file_set)[0]->output_filename  = OUTPUT_DIR"/new_RAW_4K_0.RAW";
    (*file_set)[1]->output_filename  = OUTPUT_DIR"/new_RAW_4K_1.RAW";
    (*file_set)[2]->output_filename  = OUTPUT_DIR"/new_RAW_4K_2.RAW";
    (*file_set)[3]->output_filename  = OUTPUT_DIR"/new_RAW_4K_3.RAW";
    (*file_set)[4]->output_filename  = OUTPUT_DIR"/new_RAW_4K_4.RAW";
    (*file_set)[5]->output_filename  = OUTPUT_DIR"/new_RAW_4K_5.RAW";
    (*file_set)[6]->output_filename  = OUTPUT_DIR"/new_RAW_4K_6.RAW";
    (*file_set)[7]->output_filename  = OUTPUT_DIR"/new_RAW_4K_7.RAW";
    (*file_set)[8]->output_filename  = OUTPUT_DIR"/new_RAW_4K_8.RAW";
    (*file_set)[9]->output_filename  = OUTPUT_DIR"/new_RAW_4K_9.RAW";
